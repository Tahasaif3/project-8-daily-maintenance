...
### 2026-08-17
project-4-fix-loop had one new commit (trivial README typo fix, no
functional change). project-5-codify-body and project-6-doorbell-loop had
no new activity. Digest written to NOTES.md.
